...
if __name__ == "__main__":
    ...
    client.moveToZAsync(-30, 2).join()   # 上升到15m高度

    drivetrain = airsim.DrivetrainType.ForwardOnly
    yaw_mode = airsim.YawMode(False, 90)

    client.moveToPositionAsync(10, 0, -30, 1, drivetrain=drivetrain, yaw_mode=yaw_mode).join()  # 飞到（10,0）点坐标
    client.moveToPositionAsync(10, 10, -30, 1, drivetrain=drivetrain, yaw_mode=yaw_mode).join()  # 飞到（10,10）点坐标
